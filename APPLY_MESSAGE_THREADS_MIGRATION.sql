-- Script para aplicar a migration 020_message_threads.sql
...
DROP POLICY IF EXISTS "Users can view threads in their rooms" ON message_threads;
DROP POLICY IF EXISTS "Users can create threads in their rooms" ON message_threads;
